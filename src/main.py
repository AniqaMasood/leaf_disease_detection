...
from leaf_disease_detector.leaf_disease_detection_main import main as detect_leaf_disease
import asyncio
...
async def on_startup():
    ...
    detect_leaf_disease(IMAGE_PATH)  # Call the function to detect leaf disease
